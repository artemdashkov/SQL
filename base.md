...
**Нормализованная база данных (нормальные формы БД)**
**Какие нормальные формы бывают (по номерам...)**
...
## DISTINCT
Иногда нужны не все данные из таблицы, а только уникальные значения в столбце (другими словами разных). Например, мы хотим получить всех авторов книг в таблице books.
